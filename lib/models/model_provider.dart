...
class ModelProvider implements amplify_core.ModelProviderInterface {
  @override
  String version = "68f5aeb2d0970a6d1abbd1a8857d6df9";
  @override
  List<amplify_core.ModelSchema> modelSchemas = [
    BOOKINGDETAILS5.schema,
    CLEAfternoon.schema,
    CLEMorning.schema,
    KAPAfternoon.schema,
    KAPMorning.schema,
  ...
  amplify_core.ModelType getModelTypeByModelName(String modelName) {
    switch (modelName) {
      ...
      case "CLEAfternoon":
        return CLEAfternoon.classType;
      case "CLEMorning":
        return CLEMorning.classType;
      case "KAPAfternoon":
        return KAPAfternoon.classType;
      case "KAPMorning":
        return KAPMorning.classType;
      default:
        throw Exception(
